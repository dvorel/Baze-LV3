...
SELECT * FROM osobe;	/*provjera unosa*/

/*ovo dalje je drugi*/

/*zamjena ime, prezime*/
UPDATE osobe
SET prezime = ime, ime = prezime
WHERE ime = 'Pero';

/*povecanje broja cipelica*/
UPDATE osobe
SET broj_cipela = broj_cipela + 5;

/*brisanje 3. osobe*/
DELETE FROM osobe WHERE jmbg = '2';

SELECT * FROM osobe;	/*provjera*/
